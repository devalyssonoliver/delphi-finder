...
begin
  ...
  try
    ...
    BotaoIncluir.Width := 80;
    BotaoIncluir.Height := 25;
    BotaoIncluir.Caption := FBotaoIncluirCaption;
    BotaoIncluir.Top := (Rodape.Height - BotaoIncluir.Height) div 2;
    BotaoIncluir.Left := BotaoEspacamento;

    BotaoCancelar := TBitBtn.Create(Rodape);
    BotaoCancelar.Parent := Rodape;
    BotaoCancelar.Kind := bkCancel;
    BotaoCancelar.Width := 80;
    BotaoCancelar.Height := 25;
    BotaoCancelar.Caption := 'Cancelar';
    BotaoCancelar.Top := (Rodape.Height - BotaoCancelar.Height) div 2;
    BotaoCancelar.Left := Rodape.Width - BotaoCancelar.Width - BotaoEspacamento;
    ...
    BotaoOk.Left := BotaoCancelar.Left - BotaoOk.Width - BotaoEspacamento;
